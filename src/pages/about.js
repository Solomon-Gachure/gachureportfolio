...
const About = () => {
  return (
    <div className='p-2 h-full font-roboto' >
        <div>
...
<div className='flex justify-center items-center max-w-4xl'>
  <p className='font-mono text-lg '>Salut!👋🏾 <b>Solomon Gachure</b> here, however you can call me Solomon!<br/>
...
<div className='flex flex-col justify-center items-center p-4 w-full'>
  ...
  <div>
    <div className='max-w-4xl'>
      <h1 className='text-stone-300 font-bold'>Software Engineer Intern - <b className='text-amber-400'>Awol</b></h1>
